...
namespace ae{
// constructor
Mesh::Mesh(MeshFactoryContext meshFactoryContext) : Asset(static_cast<BaseFactoryContext>(meshFactoryContext) ), vertices(meshFactoryContext.vertices), indices(meshFactoryContext.indices) {

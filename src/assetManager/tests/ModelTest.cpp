...
BOOST_AUTO_TEST_CASE(TestLoadBox)
{
    ...
    ae::AssetFactoryData factoryData(manager, "C:/Users/redkc/CLionProjects/ReasonableVulkan/res/models/my/Box.fbx", ae::AssetType::Model);
...
BOOST_AUTO_TEST_CASE(TestLoadPlaneAndSphere)
{
    ...
    // Load Plane
    ae::AssetFactoryData planeData(manager, "C:/Users/redkc/CLionProjects/ReasonableVulkan/res/models/my/Plane.fbx", ae::AssetType::Model);
    ...
    // Load Sphere
    ae::AssetFactoryData sphereData(manager, "C:/Users/redkc/CLionProjects/ReasonableVulkan/res/models/my/Sphere.fbx", ae::AssetType::Model);
...
BOOST_AUTO_TEST_CASE(TestModelContentHash)
{
    ...
    ae::AssetFactoryData firstData(manager, "C:/Users/redkc/CLionProjects/ReasonableVulkan/res/models/my/Box.fbx", ae::AssetType::Model);
...
BOOST_AUTO_TEST_CASE(TestInvalidModel)
{
    ...
    ae::AssetFactoryData invalidData(manager, "C:/Users/redkc/CLionProjects/ReasonableVulkan/res/models/my/NonExistent.fbx", ae::AssetType::Model);

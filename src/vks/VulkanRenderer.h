...
#include "src/assetBufferManager/AssetHandleManager.h"
#include "vulkan/vulkan.h"

#include "src/base/CommandLineParser.hpp"
#include "src/base/keycodes.hpp"
#include "src/base/VulkanTools.h"
#include "src/base/VulkanDebug.h"
#include "src/base/VulkanUIOverlay.h"
#include "src/base/VulkanSwapChain.h"
#include "src/base/VulkanBuffer.h"
#include "src/base/VulkanDevice.h"
#include "src/base/VulkanTexture.h"

#include "src/base/camera.hpp"
#include "src/base/benchmark.hpp"
#include "src/base/VulkanglTFModel.h"
...
protected:
	// Manager for buffers and descriptors
    vks::AssetHandleManager assetHandleManager;
    ...
    VkQueue graphicsQueue{VK_NULL_HANDLE};
        // Handle to the device transfer queue that command buffers are submitted to
...
public:
    ...
    vks::base::UIOverlay ui;

    vks::base::Benchmark benchmark;

    /** @brief Encapsulated physical and logical vulkan device */
    vks::base::VulkanDevice *vulkanDevice{};
...
;
    ...
    /** @brief  Called when the window has been resized, can be used by the sample application to recreate resources */
    void windowResized();

    /** @brief  Called when resources have been recreated that require a rebuild of the command buffers (e.g. frame buffer), to be implemented by the sample application */
    void buildCommandBuffers();

    /** @brief  Setup default depth and stencil views */
    void setupDepthStencil();

    /** @brief  Setup default framebuffers for all requested swapchain images */
    void setupFrameBuffer();

    /** @brief  Setup a default renderpass */
    void setupRenderPass();

    /** @brief  Called after the physical device features have been read, can be used to set features to enable on the device */
    void getEnabledFeatures();

    /** @brief  Called after the physical device extensions have been read, can be used to enable extensions based on the supported extension listing*/
    ...
    /*
    /** @brief Entry point for the main render loop #1#
    void renderLoop();*/
    ...
    /** @brief  Default image acquire + submission and command buffer submission function */
    void renderFrame();

    /** @brief Called when the UI overlay is updating, can be used to add custom elements to the overlay */
    void OnUpdateUIOverlay(vks::base::UIOverlay *overlay);

#if defined(_WIN32)
#endif
};

#include "src/base/Entrypoints.h"

...
{
if (vks::base::tools::resourcePath != "") {
	return vks::base::tools::resourcePath + "/res/";
}
...
{
if (vks::base::tools::resourcePath != "") {
	return vks::base::tools::resourcePath + "/shaders/";
}
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
	return "shaders/";
...
#undef STR
			...
			VkPipelineStageFlags dstStageMask)
		{
			...
			VkImageMemoryBarrier imageMemoryBarrier = vks::base::initializers::imageMemoryBarrier();
		...
		void exitFatal(const std::string& message, int32_t exitCode)
		{
			...
			vks::base::android::showAlert(message.c_str());
#endif
			std::cerr << message << "\n";

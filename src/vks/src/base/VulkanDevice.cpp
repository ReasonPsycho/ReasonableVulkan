...
{	
	...
	*/
	VkResult VulkanDevice::createBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, VkDeviceSize size, VkBuffer *buffer, VkDeviceMemory *memory, void *data)
	{
		...
		VkBufferCreateInfo bufferCreateInfo = vks::base::initializers::bufferCreateInfo(usageFlags, size);
		bufferCreateInfo.sharingMode = VK_SHARING_MODE_EXCLUSIVE;
		VK_CHECK_RESULT(vkCreateBuffer(logicalDevice, &bufferCreateInfo, nullptr, buffer));

		// Create the memory backing up the buffer handle
		VkMemoryRequirements memReqs;
		VkMemoryAllocateInfo memAlloc = vks::base::initializers::memoryAllocateInfo();
		...
		if (data != nullptr)
		{
			...
			{
				VkMappedMemoryRange mappedRange = vks::base::initializers::mappedMemoryRange();
	...
	* @return VK_SUCCESS if buffer handle and memory have been created and (optionally passed) data has been copied
	*/
	VkResult VulkanDevice::createBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, vks::base::Buffer *buffer, VkDeviceSize size, void *data)
	{
	...
	*/
	void VulkanDevice::copyBuffer(vks::base::Buffer *src, vks::base::Buffer *dst, VkQueue queue, VkBufferCopy *copyRegion)
	{
	...
	*/
	...
	{
		VkCommandBufferAllocateInfo cmdBufAllocateInfo = vks::base::initializers::commandBufferAllocateInfo(pool, level, 1);
	...
	*/
	void VulkanDevice::flushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue, VkCommandPool pool, bool free)
	{
		...
		VkSubmitInfo submitInfo = vks::base::initializers::submitInfo();
		submitInfo.commandBufferCount = 1;
		submitInfo.pCommandBuffers = &commandBuffer;
		// Create fence to ensure that the command buffer has finished executing
		VkFenceCreateInfo fenceInfo = vks::base::initializers::fenceCreateInfo(VK_FLAGS_NONE);
		VkFence fence;

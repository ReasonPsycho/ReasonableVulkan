...
namespace vkglTF {
	...
	*/
	struct Texture {
		vks::base::VulkanDevice *device = nullptr;
		VkImage image;
		...
		void fromglTfImage(tinygltf::Image &gltfimage, std::string path, vks::base::VulkanDevice *device, VkQueue copyQueue);
	};
	...
	*/
	struct Material {
		...
		Material(vks::base::VulkanDevice *device) : device(device) {
		};
	...
	*/
	struct Mesh {
		...
		Mesh(vks::base::VulkanDevice *device, glm::mat4 matrix);
	...
	*/
	...
	public:
		...
		void loadImages(tinygltf::Model &gltfModel, vks::base::VulkanDevice *device, VkQueue transferQueue);

		void loadMaterials(tinygltf::Model &gltfModel);

		void loadAnimations(tinygltf::Model &gltfModel);

		void loadFromFile(std::string filename, vks::base::VulkanDevice *device, VkQueue transferQueue,

...
namespace vks::base
{
	...
	*/
	...
	public:
		...
		VkSampler sampler;
		std::vector<vks::base::FramebufferAttachment> attachments;
		...
		*/
		Framebuffer(vks::base::VulkanDevice *vulkanDevice)
		{
			assert(vulkanDevice);
		...
		*/
		uint32_t addAttachment(vks::base::AttachmentCreateInfo createinfo)
		{
			vks::base::FramebufferAttachment attachment;
			...
			VkImageCreateInfo image = vks::base::initializers::imageCreateInfo();
			...
			VkImageViewCreateInfo imageView = vks::base::initializers::imageViewCreateInfo();
